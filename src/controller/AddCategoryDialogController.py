...
from src.gui.tabs.add_category_dialog import Ui_CategoryManagerDialog
...
class AddCategoryDialogController(QDialog, Ui_CategoryManagerDialog):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self._active_threads: List[tuple] = []  # giu tham chieu de tranh GC luong dang chay
    ...
    def _run_async(self, func, on_success, **kwargs) -> None:
        ...
        con dang chay (neu khong se chet am tham, khong co loi, khong co du lieu)."""
        thread = QThread(self)

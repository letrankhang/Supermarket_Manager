...
from src.controller.PasswordResetWorker import GENERIC_ERROR_MESSAGE, SendCodeWorker
from src.gui.verification_code_ui import Ui_MainWindow
from src.services.PasswordResetService import PasswordResetError
from src.services.impl.PasswordResetServiceImpl import (RESEND_COOLDOWN,
...
RESEND_COOLDOWN_SECONDS = int(RESEND_COOLDOWN.total_seconds())
...
class VerificationCodeController(QMainWindow, Ui_MainWindow):
    ...
    def _bat_dau_dem_nguoc(self) -> None:
        self._seconds_left = RESEND_COOLDOWN_SECONDS
        self.pushButton_resend.setEnabled(False)
    ...
    def _dem_nguoc(self) -> None:
        ...
        self.pushButton_resend.setText(f"Gửi lại mã sau {self._seconds_left}s")

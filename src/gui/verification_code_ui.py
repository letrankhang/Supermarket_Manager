...
"}")
        ...
        self.code_card.setMinimumSize(QSize(420, 415))
        self.code_card.setMaximumSize(QSize(420, 415))
...
"}")
        ...
        self.lblTitle.setGeometry(QRect(10, 80, 401, 71))
        ...
        self.lblSubtitle.setGeometry(QRect(10, 121, 401, 41))
        ...
        self.dividerLine.setGeometry(QRect(40, 175, 341, 1))
        ...
        self.lblField.setGeometry(QRect(40, 190, 75, 31))
        ...
        self.lineEdit_code.setGeometry(QRect(40, 220, 341, 42))
        ...
        self.pushButton_accept.setGeometry(QRect(40, 300, 341, 61))
        ...
        self.lblBackLogin.setGeometry(QRect(240, 360, 61, 51))
        ...
        self.layoutWidget.setGeometry(QRect(40, 260, 341, 41))
        ...
        self.label.setGeometry(QRect(130, 360, 123, 51))

...
"")
    ...
    def retranslateUi(self, SupplierDialog):
        ...
        self.txtCompanyName.setPlaceholderText(QCoreApplication.translate("SupplierDialog", u"V\u00ed d\u1ee5: C\u00f4ng ty TNHH ABC...", None))
        self.label_2.setText(QCoreApplication.translate("SupplierDialog", u"Ng\u01b0\u1eddi li\u00ean h\u1ec7:", None))
        self.txtContactName.setPlaceholderText(QCoreApplication.translate("SupplierDialog", u"Nh\u1eadp t\u00ean ng\u01b0\u1eddi \u0111\u1ea1i di\u1ec7n...", None))
